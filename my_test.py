...
def pytest_generate_tests(
    metafunc,
):  # Dynamic param for given directory, fail when directory is missing
    ...
    csv_files = [
        os.path.join("./test-data/", item) for item in listing if item.endswith(".csv")
    ]  # Listed full path: parent folder + file .csv
